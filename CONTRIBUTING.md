# Contributing to CshKit

Thanks for helping improve CshKit. Bug reports, focused fixes, documentation improvements, and well-scoped features are welcome.
...
- Search [existing issues](https://github.com/focale-editor/cshkit/issues) before opening a new one.
...
CshKit follows the SDK constraint in [`pubspec.yaml`](pubspec.yaml). Install a compatible stable Dart SDK, fork the repository, and run:

```sh
git clone https://github.com/YOUR_ACCOUNT/cshkit.git
cd cshkit
dart pub get
```
